...
int encfs_stash_mount(const char *crypt_dir, const char *mount_dir, const char *password, int idle_timeout, gboolean allow_other, char **output);
int encfs_stash_unmount (const char *mount_dir);
gboolean crypt_is_mounted(const char *mount_dir);
